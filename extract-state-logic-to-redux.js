...
// performing locally in its state into Redux. This is the first step to connect
// the simple React app to Redux. The only functionality your app has is to add
// new messages from the user to an unordered list. The example is simple in
// order to demonstrate how React and Redux work together.

// First, define an action type ADD and set it to a const ADD. Next, define an
// action creator addMessage() which creates the action to add a message. You'll
// need to pass a message to this action creator and include the message in the
// returned action.
